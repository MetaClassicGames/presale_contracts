 ...
 */
contract LegendE0 is ERC721, ERC721Enumerable, Pausable, AccessControl, ERC721Burnable {
    // Token counter
     ...
     */
    constructor(address[] memory _beneficiaries, uint8[] memory _quantities, uint64 _timestampEndOfPS) ERC721("LegendEd0", "LG0") {

 ...
 */
contract Rookie is ERC721, ERC721Enumerable, Pausable, AccessControl, ERC721Burnable {
    ...
    constructor() ERC721("RookieEd0", "RKE0") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://www.metaclassicgames.com/tokens/ed0/0.json";
    }
